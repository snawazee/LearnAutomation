...
public class Constants {
	...
	//************************** Error Messages ***********************
	public static final String LOGIN_TITLE_ERROR_MESSG = "login page title is not found";
	public static final String CONTACTS_TITLE_ERROR_MESSG = "contacts page title is not found";

	public static final String SIGNUP_LINK_ERROR_MESSG = "sign up link is not present";
